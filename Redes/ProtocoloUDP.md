El protocolo **UDP (User Datagram Protocol)** es uno de los principales protocolos de transporte en la arquitectura de redes TCP/IP, junto con [TCP](ProtocoloTCP). 
